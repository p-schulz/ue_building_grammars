	...
	ToolkitWidget = SNew(SVerticalBox)
		...
		[
			...
			.Text(NSLOCTEXT("BuildingGrammar", "EditorModeInstructions",
				...
				"the selected Active Style Name (or Auto for tag-based selection), plus the Levels/Roof "
				"Type overrides below if enabled; Escape/right-click cancels. Enable Snap Edges to 15° to "
				"snap each new edge's direction to 15-degree increments, same as FlexNetwork's road angle "
				"snap.\n"
