	...
	TArray<FGrammarFace>& OutFaces)
{
	...
	// See GrammarKitAssetBuilder.cpp's GUnitBoxFaces comment for this exact table's history --
	// kept identical to that (live) copy for consistency; do not hand-derive a "fix" for this
	// without an empirical Show Normals check backing it up.
	OutFaces.Reset(6);
